...
(function (global) {
  ...
  function ensureModalRoot() {
    ...
    if (!document.getElementById('ttAuthStyles')) {
      ...
      st.textContent = [
        ...
        '.tt-admin-btn{position:absolute;right:12px;top:50%;transform:translateY(-50%);background:#334155!important;color:#e2e8f0!important;font-size:13px!important;padding:8px 12px!important;margin:0!important;z-index:3;border:none;border-radius:6px;cursor:pointer}',
        '@media (max-width:600px){.tt-admin-btn{top:10px;transform:none;right:10px;font-size:12px!important;padding:6px 10px!important}}'
      ].join('');
  ...
  function injectAdminButton() {
    ...
    if (!header || document.getElementById('ttAdminToolsBtn')) return;
