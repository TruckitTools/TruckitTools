  ...
  function ensureModalRoot() {
    ...
    if (!document.getElementById('ttAuthStyles')) {
      ...
      st.textContent = [
        ...
        '.tt-admin-btn{position:absolute;left:12px;top:50%;transform:translateY(-50%);background:#16a34a!important;color:#000!important;font-size:13px!important;font-weight:bold;padding:8px 12px!important;margin:0!important;z-index:3;border:none;border-radius:6px;cursor:pointer}',
        '@media (max-width:600px){.tt-admin-btn{left:12px;top:10px;transform:none;font-size:13px!important;padding:8px 12px!important}}'
      ].join('');
